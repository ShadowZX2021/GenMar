...
namespace ControlGastosMVC.Controllers
{
    public class NivelUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdNivelUsuario,Descripcion,IdEstatus")] NivelUsuario nivelUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdNivelUsuario,Descripcion,IdEstatus")] NivelUsuario nivelUsuario)
        {
            if (ModelState.IsValid)
            {
